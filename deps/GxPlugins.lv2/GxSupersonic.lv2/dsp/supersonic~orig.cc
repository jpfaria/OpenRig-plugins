...
#define fslider2 (*fslider2_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = (4.88029546708067e-05 * fRec5[0]);
		double fTemp2 = (0.00104438322995526 + (fConst0 * (7.87879236161215e-06 + (fRec5[0] * (5.02670433109309e-05 - fTemp1)))));
		double fTemp3 = (6.19487506474243e-07 + (3.09743753237122e-05 * fRec5[0]));
		fRec6[0] = ((double)input0[i] - ((fRec6[1] * (0.00104438322995526 + (fConst0 * ((fRec5[0] * (fTemp1 - 5.02670433109309e-05)) - 7.87879236161215e-06)))) / fTemp2));
