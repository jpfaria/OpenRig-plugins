...
void gx_gui_create_window_and_surface(gx_sloopyblueUI *ui) {
	...
	static TCHAR szClassName[] = TEXT("gx_sloopyblueUIClass");
	WNDCLASS wndclass = {0};
...
void gx_gui_destroy_main_window(gx_sloopyblueUI *ui) {
	...
	UnregisterClass(TEXT("gx_sloopyblueUIClass"), NULL);
}
...
void event_handler(gx_sloopyblueUI *ui) {
}
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	gx_sloopyblueUI *ui = (gx_sloopyblueUI *)GetWindowLongPtr(hwnd, GWLP_USERDATA);
