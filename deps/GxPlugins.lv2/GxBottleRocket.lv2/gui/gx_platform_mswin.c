...
void gx_gui_create_window_and_surface(gx_bottlerocketUI *ui) {
	...
	static TCHAR szClassName[] = TEXT("gx_bottlerocketUIClass");
	WNDCLASS wndclass = {0};
...
void gx_gui_destroy_main_window(gx_bottlerocketUI *ui) {
	...
	UnregisterClass(TEXT("gx_bottlerocketUIClass"), NULL);
}
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	gx_bottlerocketUI *ui = (gx_bottlerocketUI *)GetWindowLongPtr(hwnd, GWLP_USERDATA);
