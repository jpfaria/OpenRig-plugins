...
void gx_gui_create_window_and_surface(gx_TubeDistortionUI *ui) {
	...
	static TCHAR szClassName[] = TEXT("gx_TubeDistortionUIClass");
	WNDCLASS wndclass = {0};
...
void gx_gui_destroy_main_window(gx_TubeDistortionUI *ui) {
	...
	UnregisterClass(TEXT("gx_TubeDistortionUIClass"), NULL);
}
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	gx_TubeDistortionUI *ui = (gx_TubeDistortionUI *)GetWindowLongPtr(hwnd, GWLP_USERDATA);
