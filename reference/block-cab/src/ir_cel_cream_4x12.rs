...
pub const MODEL_ID: &str = "cel_cream_4x12";
pub const DISPLAY_NAME: &str = "Celestion Cream 4x12";
...
pub struct CelCream4x12Capture {
    pub capture: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[CelCream4x12Capture] = &[
    capture!("sm57_dark", "cabs/cel_cream_4x12/sm57_dark.wav"),
    capture!("sm57_fat", "cabs/cel_cream_4x12/sm57_fat.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static CelCream4x12Capture> {
...
mod tests {
    ...
    fn builds_mono_processor_for_curated_capture() {
        ...
        assert!(summary.contains("cab.cel_cream_4x12.sm57_dark"));
    }
}
