...
pub const MODEL_ID: &str = "lv2_mod_hpf";
pub const DISPLAY_NAME: &str = "MOD High Pass";
const BRAND: &str = "mod";

const PLUGIN_URI: &str = "http://moddevices.com/plugins/mod-devel/HighPassFilter";
const PLUGIN_DIR: &str = "mod-hpf";

#[cfg(target_os = "macos")]
const PLUGIN_BINARY: &str = "mod-hpf.dylib";
#[cfg(target_os = "linux")]
const PLUGIN_BINARY: &str = "mod-hpf.so";
#[cfg(target_os = "windows")]
const PLUGIN_BINARY: &str = "mod-hpf.dll";
