...
const CAPTURES: &[NamCapture] = &[
    NamCapture { tone: "thorpy_fx_peacekeeper_esr_0_0004", model_path: "pedals/thorpyfx_peacekeeper/thorpy_fx_peacekeeper_esr_0_0004.nam" },
];
...
pub fn model_schema() -> ModelParameterSchema {
    ...
    schema.parameters = vec![enum_parameter(
        ...
        "Tone",
        Some("Pedal"),
        Some("thorpy_fx_peacekeeper_esr_0_0004"),
        &[
            ("thorpy_fx_peacekeeper_esr_0_0004", "Thorpy Fx Peacekeeper Esr 0 0004"),
        ],
    )];
    schema
}
