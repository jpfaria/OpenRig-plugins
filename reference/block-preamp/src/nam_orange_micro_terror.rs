...
pub const MODEL_ID: &str = "nam_orange_micro_terror";
pub const DISPLAY_NAME: &str = "Micro Terror";
const BRAND: &str = "orange";

const NAM_FILE: &str = "preamp/nam_orange_micro_terror/volume5_tone7_gain5.nam";
