...
pub const MODEL_ID: &str = "nam_engl_e530";
pub const DISPLAY_NAME: &str = "E530";
...
// Single-capture preset pack: only one E530 voicing available.
const CAPTURES: &[(&str, &str, &str)] = &[
    ("default", "Default", "preamp/engl_e530/engl_e530.nam"),
];
