...
pub const MODEL_ID: &str = "nam_sovtek_mig100";
pub const DISPLAY_NAME: &str = "MIG-100 KT88";
const BRAND: &str = "sovtek";
...
const CAPTURES: &[(&str, &str)] = &[
    ("v1", "preamp/nam_sovtek_mig100/v1.nam"),
    ("v2", "preamp/nam_sovtek_mig100/v2.nam"),
    ("v3", "preamp/nam_sovtek_mig100/v3.nam"),
];

pub fn model_schema() -> ModelParameterSchema {
    let mut schema = model_schema_for(block_core::EFFECT_TYPE_PREAMP, MODEL_ID, DISPLAY_NAME, false);
    schema.parameters = vec![
        enum_parameter("voicing", "Voicing", Some("Amp"), Some("v1"),
            &[("v1", "V1"), ("v2", "V2"), ("v3", "V3")]),
    ];
    schema
}
