...
pub const MODEL_ID: &str = "nam_lab_series_l2";
pub const DISPLAY_NAME: &str = "L2";
const BRAND: &str = "lab-series";
...
const CAPTURES: &[(&str, &str)] = &[
    ("clean",  "preamp/nam_lab_series_l2/clean.nam"),
    ("crunch", "preamp/nam_lab_series_l2/crunch.nam"),
    ("od",     "preamp/nam_lab_series_l2/od.nam"),
];
