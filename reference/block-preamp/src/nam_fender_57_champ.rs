...
pub const MODEL_ID: &str = "nam_fender_57_champ";
pub const DISPLAY_NAME: &str = "'57 Custom Champ";
...
const CAPTURES: &[(&str, &str, &str)] = &[
    ("clean",  "1", "preamp/nam_fender_57_champ/clean_in1.nam"),
    ("clean",  "2", "preamp/nam_fender_57_champ/clean_in2.nam"),
    ("crunch", "1", "preamp/nam_fender_57_champ/crunch_in1.nam"),
    ("crunch", "2", "preamp/nam_fender_57_champ/crunch_in2.nam"),
    ("od",     "1", "preamp/nam_fender_57_champ/od_in1.nam"),
    ("od",     "2", "preamp/nam_fender_57_champ/od_in2.nam"),
];
