...
pub const MODEL_ID: &str = "nam_peavey_classic_30";
pub const DISPLAY_NAME: &str = "Classic 30";
...
const CAPTURES: &[(&str, &str)] = &[
    ("clean",       "preamp/nam_peavey_classic_30/clean.nam"),
    ("clean_boost", "preamp/nam_peavey_classic_30/clean_boost.nam"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ...
    schema.parameters = vec![
        enum_parameter("voicing", "Voicing", Some("Amp"), Some("clean"),
            &[("clean", "Clean"), ("clean_boost", "Clean w/ Boost")]),
    ];
    schema
}
