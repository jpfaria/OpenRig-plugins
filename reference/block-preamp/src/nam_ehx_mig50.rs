...
pub const MODEL_ID: &str = "nam_ehx_mig50";
pub const DISPLAY_NAME: &str = "MIG-50";
...
const CAPTURES: &[(&str, &str)] = &[
    ("clean",  "preamp/nam_ehx_mig50/clean.nam"),
    ("crunch", "preamp/nam_ehx_mig50/crunch.nam"),
    ("od",     "preamp/nam_ehx_mig50/od.nam"),
];
