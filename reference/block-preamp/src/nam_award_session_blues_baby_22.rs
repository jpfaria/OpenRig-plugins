...
pub const MODEL_ID: &str = "nam_award_session_blues_baby_22";
pub const DISPLAY_NAME: &str = "Blues Baby 22";
const BRAND: &str = "award-session";
...
const CAPTURES: &[(&str, &str)] = &[
    ("clean",  "preamp/nam_award_session_blues_baby_22/clean.nam"),
    ("crunch", "preamp/nam_award_session_blues_baby_22/crunch.nam"),
    ("od",     "preamp/nam_award_session_blues_baby_22/od.nam"),
];
