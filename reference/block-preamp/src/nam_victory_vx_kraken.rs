...
pub const MODEL_ID: &str = "nam_victory_vx_kraken";
pub const DISPLAY_NAME: &str = "VX Kraken";
const BRAND: &str = "victory";
...
const CAPTURES: &[(&str, &str)] = &[
    ("shred_di",   "preamp/nam_victory_vx_kraken/shred_di.nam"),
    ("shred_full", "preamp/nam_victory_vx_kraken/shred_full.nam"),
];

pub fn model_schema() -> ModelParameterSchema {
    let mut schema = model_schema_for(block_core::EFFECT_TYPE_PREAMP, MODEL_ID, DISPLAY_NAME, false);
    schema.parameters = vec![
        enum_parameter("voicing", "Voicing", Some("Amp"), Some("shred_di"),
            &[("shred_di", "Shred DI"), ("shred_full", "Shred Full")]),
    ];
    schema
}
