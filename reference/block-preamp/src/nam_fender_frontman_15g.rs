...
pub const MODEL_ID: &str = "nam_fender_frontman_15g";
pub const DISPLAY_NAME: &str = "Frontman 15G";
...
const CAPTURES: &[(&str, &str)] = &[
    ("clean",       "preamp/nam_fender_frontman_15g/clean.nam"),
    ("clean_boost", "preamp/nam_fender_frontman_15g/clean_boost.nam"),
    ("high_gain",   "preamp/nam_fender_frontman_15g/high_gain.nam"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ...
    schema.parameters = vec![
        enum_parameter("voicing", "Voicing", Some("Amp"), Some("clean"),
            &[("clean", "Clean"), ("clean_boost", "Clean Boost"), ("high_gain", "High Gain")]),
    ];
    schema
}
