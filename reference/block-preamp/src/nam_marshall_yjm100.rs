...
pub const MODEL_ID: &str = "nam_marshall_yjm100";
pub const DISPLAY_NAME: &str = "YJM100";
...
const CAPTURES: &[(&str, &str)] = &[
    ("standard",     "preamp/nam_marshall_yjm100/standard.nam"),
    ("jcm800_mode",  "preamp/nam_marshall_yjm100/jcm800_mode.nam"),
    ("boost_bright", "preamp/nam_marshall_yjm100/boost_bright.nam"),
    ("modern",       "preamp/nam_marshall_yjm100/modern.nam"),
];

pub fn model_schema() -> ModelParameterSchema {
    let mut schema = model_schema_for(block_core::EFFECT_TYPE_PREAMP, MODEL_ID, DISPLAY_NAME, false);
    schema.parameters = vec![
        enum_parameter("voicing", "Voicing", Some("Amp"), Some("standard"),
            &[
                ("standard",     "Standard"),
                ("jcm800_mode",  "JCM 800 Mode"),
                ("boost_bright", "Boost + Bright"),
                ("modern",       "Modern"),
            ]),
    ];
    schema
