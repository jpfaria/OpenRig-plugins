...
pub const MODEL_ID: &str = "nam_zt_lunchbox_jr";
pub const DISPLAY_NAME: &str = "Lunchbox Jr";
const BRAND: &str = "zt";
...
const CAPTURES: &[(&str, &str)] = &[
    ("clean",  "preamp/nam_zt_lunchbox_jr/clean.nam"),
    ("crunch", "preamp/nam_zt_lunchbox_jr/crunch.nam"),
    ("od",     "preamp/nam_zt_lunchbox_jr/od.nam"),
];
