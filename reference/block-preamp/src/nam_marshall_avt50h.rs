...
pub const MODEL_ID: &str = "nam_marshall_avt50h";
pub const DISPLAY_NAME: &str = "AVT50H";
...
const CAPTURES: &[(&str, &str)] = &[
    ("hg_bass_cut",    "preamp/nam_marshall_avt50h/hg_bass_cut.nam"),
    ("hg_dimed",       "preamp/nam_marshall_avt50h/hg_dimed.nam"),
    ("hg_mid_cut",     "preamp/nam_marshall_avt50h/hg_mid_cut.nam"),
    ("hg_mid_forward", "preamp/nam_marshall_avt50h/hg_mid_forward.nam"),
    ("hg_treb_cut",    "preamp/nam_marshall_avt50h/hg_treb_cut.nam"),
];

pub fn model_schema() -> ModelParameterSchema {
    let mut schema = model_schema_for(block_core::EFFECT_TYPE_PREAMP, MODEL_ID, DISPLAY_NAME, false);
    schema.parameters = vec![
        enum_parameter("voicing", "Voicing", Some("Amp"), Some("hg_dimed"),
            &[
                ("hg_bass_cut",    "HG Bass Cut"),
                ("hg_dimed",       "HG Dimed"),
                ("hg_mid_cut",     "HG Mid Cut"),
                ("hg_mid_forward", "HG Mid Forward"),
                ("hg_treb_cut",    "HG Treb Cut"),
            ]),
    ];
    schema
}
