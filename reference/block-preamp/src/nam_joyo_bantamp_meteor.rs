...
pub const MODEL_ID: &str = "nam_joyo_bantamp_meteor";
pub const DISPLAY_NAME: &str = "Bantamp Meteor";
const BRAND: &str = "joyo";
...
const CAPTURES: &[(&str, &str)] = &[
    ("clean",         "preamp/nam_joyo_bantamp_meteor/clean.nam"),
    ("clean_gain",    "preamp/nam_joyo_bantamp_meteor/clean_gain.nam"),
    ("low_crunch",    "preamp/nam_joyo_bantamp_meteor/low_crunch.nam"),
    ("crunch",        "preamp/nam_joyo_bantamp_meteor/crunch.nam"),
    ("high_gain",     "preamp/nam_joyo_bantamp_meteor/high_gain.nam"),
    ("high_gain_808", "preamp/nam_joyo_bantamp_meteor/high_gain_808.nam"),
    ("maxed",         "preamp/nam_joyo_bantamp_meteor/maxed.nam"),
];
    ...
    schema.parameters = vec![
        enum_parameter("voicing", "Voicing", Some("Amp"), Some("clean"),
            &[
                ...
                ("low_crunch",    "Low Crunch"),
                ("crunch",        "Crunch"),
                ("high_gain",     "High Gain"),
                ("high_gain_808", "High Gain 808"),
                ("maxed",         "Maxed"),
            ]),
    ];
    schema
