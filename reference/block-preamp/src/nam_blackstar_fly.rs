...
pub const MODEL_ID: &str = "nam_blackstar_fly";
pub const DISPLAY_NAME: &str = "Fly";
...
const CAPTURES: &[(&str, &str)] = &[
    ("clean",  "preamp/nam_blackstar_fly/clean.nam"),
    ("crunch", "preamp/nam_blackstar_fly/crunch.nam"),
    ("od",     "preamp/nam_blackstar_fly/od.nam"),
];
