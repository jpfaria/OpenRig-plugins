...
pub const MODEL_ID: &str = "nam_synergy_dumble_os";
pub const DISPLAY_NAME: &str = "Dumble OS Module";
...
// Single-axis preset pack: 2 channels (clean / overdrive) on EL34 power section.
const CAPTURES: &[(&str, &str, &str)] = &[
    ("ch1", "Channel 1", "preamp/synergy_dumble_os/os_ch1_el34ab_19_4.nam"),
    ("ch2", "Channel 2", "preamp/synergy_dumble_os/os_ch2_el34ab_19_4.nam"),
];
