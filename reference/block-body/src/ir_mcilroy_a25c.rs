...
pub const MODEL_ID: &str = "mcilroy_a25c";
pub const DISPLAY_NAME: &str = "A25C";
...
pub const CAPTURES: &[Capture] = &[
    capture!("sc_mcilroy1_44100", "body/mcilroy_a25c/sc_mcilroy1_44100.wav"),
    capture!("sc_mcilroy1_44100_bld", "body/mcilroy_a25c/sc_mcilroy1_44100_bld.wav"),
    capture!("sc_mcilroy1_44100_match", "body/mcilroy_a25c/sc_mcilroy1_44100_match.wav"),
    capture!("sc_mcilroy1_44100_jf_flavor", "body/mcilroy_a25c/sc_mcilroy1_44100_jf_flavor.wav"),
    capture!("sc_mcilroy2_44100", "body/mcilroy_a25c/sc_mcilroy2_44100.wav"),
    capture!("sc_mcilroy2_44100_bld", "body/mcilroy_a25c/sc_mcilroy2_44100_bld.wav"),
    capture!("sc_mcilroy2_44100_jf_flavor", "body/mcilroy_a25c/sc_mcilroy2_44100_jf_flavor.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("sc_mcilroy1_44100"), &[
            ("sc_mcilroy1_44100", "Position 1"), ("sc_mcilroy1_44100_bld", "Position 1 Blend"), ("sc_mcilroy1_44100_match", "Position 1 Match"), ("sc_mcilroy1_44100_jf_flavor", "Position 1 JF Flavor"),
            ("sc_mcilroy2_44100", "Position 2"), ("sc_mcilroy2_44100_bld", "Position 2 Blend"), ("sc_mcilroy2_44100_jf_flavor", "Position 2 JF Flavor"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("sc_mcilroy1_44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
