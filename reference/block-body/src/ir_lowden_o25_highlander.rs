...
pub const MODEL_ID: &str = "lowden_o25_highlander";
pub const DISPLAY_NAME: &str = "O25 Highlander";
...
pub const CAPTURES: &[Capture] = &[
    capture!("ir_lowdeno25_highlander_48000", "body/lowden_o25_highlander/ir_lowdeno25_highlander_48000.wav"),
    capture!("ir_lowdeno25_highlander_48000_match1", "body/lowden_o25_highlander/ir_lowdeno25_highlander_48000_match1.wav"),
    capture!("ir_lowdeno25_highlander_48000_match2", "body/lowden_o25_highlander/ir_lowdeno25_highlander_48000_match2.wav"),
    capture!("jf45irlowden_o25_highlander", "body/lowden_o25_highlander/jf45irlowden_o25_highlander.wav"),
    capture!("jf45ir1024lowden_o25_highlander", "body/lowden_o25_highlander/jf45ir1024lowden_o25_highlander.wav"),
    capture!("jf45ir5050lowden_o25_highlander", "body/lowden_o25_highlander/jf45ir5050lowden_o25_highlander.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("ir_lowdeno25_highlander_48000"), &[
            ("ir_lowdeno25_highlander_48000", "Standard"), ("ir_lowdeno25_highlander_48000_match1", "Match 1"), ("ir_lowdeno25_highlander_48000_match2", "Match 2"),
            ("jf45irlowden_o25_highlander", "JF45 IR"), ("jf45ir1024lowden_o25_highlander", "JF45 IR 1024"), ("jf45ir5050lowden_o25_highlander", "JF45 IR 5050"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("ir_lowdeno25_highlander_48000".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
