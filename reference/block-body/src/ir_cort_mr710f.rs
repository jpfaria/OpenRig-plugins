...
pub const MODEL_ID: &str = "cort_mr710f";
pub const DISPLAY_NAME: &str = "MR710F";
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter(
            ...
            "Voicing",
            Some("Body"),
            Some("cort_mr710f_48000_bld"),
            &[
                ("cort_mr710f_48000", "48000"),
                ("cort_mr710f_48000_bld", "48000 Bld"),
                ("cort_mr710f_48000_jf_flavor", "48000 JF Flavor"),
                ("cort_mr710f_48000_match", "48000 Match"),
            ],
        )],
    }
}
