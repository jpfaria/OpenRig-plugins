...
pub const MODEL_ID: &str = "godin_metropolis_hfn";
pub const DISPLAY_NAME: &str = "Metropolis HFN";
const BRAND: &str = "godin";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        GodinMetropolisHfnCapture {
            voicing: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct GodinMetropolisHfnCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[GodinMetropolisHfnCapture] = &[
    capture!("jf45ir1024godin_metropolis", "body/godin_metropolis_hfn/jf45ir1024godin_metropolis.wav"),
    capture!("jf45ir5050godin_metropolis", "body/godin_metropolis_hfn/jf45ir5050godin_metropolis.wav"),
    capture!("jf45irgodin_metropolis", "body/godin_metropolis_hfn/jf45irgodin_metropolis.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("jf45irgodin_metropolis"), &[
            ("jf45ir1024godin_metropolis", "JF45 IR 1024"), ("jf45ir5050godin_metropolis", "JF45 IR 5050"), ("jf45irgodin_metropolis", "JF45 IR"),
        ])],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static GodinMetropolisHfnCapture> {
