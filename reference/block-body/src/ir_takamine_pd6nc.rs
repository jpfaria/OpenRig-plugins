...
pub const MODEL_ID: &str = "takamine_pd6nc";
pub const DISPLAY_NAME: &str = "PD6NC";
...
pub const CAPTURES: &[Capture] = &[
    capture!("takamine_pd6nc_1_44100", "body/takamine_pd6nc/takamine_pd6nc_1_44100.wav"),
    capture!("takamine_pd6nc_1_44100_bld", "body/takamine_pd6nc/takamine_pd6nc_1_44100_bld.wav"),
    capture!("takamine_pd6nc_1_44100_match", "body/takamine_pd6nc/takamine_pd6nc_1_44100_match.wav"),
    capture!("takamine_pd6nc_1_44100_jf_flavor", "body/takamine_pd6nc/takamine_pd6nc_1_44100_jf_flavor.wav"),
    capture!("takamine_pd6nc_2_44100", "body/takamine_pd6nc/takamine_pd6nc_2_44100.wav"),
    capture!("takamine_pd6nc_2_44100_bld", "body/takamine_pd6nc/takamine_pd6nc_2_44100_bld.wav"),
    capture!("takamine_pd6nc_2_44100_match", "body/takamine_pd6nc/takamine_pd6nc_2_44100_match.wav"),
    capture!("takamine_pd6nc_2_44100_jf_flavor", "body/takamine_pd6nc/takamine_pd6nc_2_44100_jf_flavor.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("takamine_pd6nc_1_44100"), &[
            ("takamine_pd6nc_1_44100", "Position 1"), ("takamine_pd6nc_1_44100_bld", "Position 1 Blend"), ("takamine_pd6nc_1_44100_match", "Position 1 Match"), ("takamine_pd6nc_1_44100_jf_flavor", "Position 1 JF Flavor"),
            ("takamine_pd6nc_2_44100", "Position 2"), ("takamine_pd6nc_2_44100_bld", "Position 2 Blend"), ("takamine_pd6nc_2_44100_match", "Position 2 Match"), ("takamine_pd6nc_2_44100_jf_flavor", "Position 2 JF Flavor"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("takamine_pd6nc_1_44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
