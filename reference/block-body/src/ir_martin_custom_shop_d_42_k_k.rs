...
pub const MODEL_ID: &str = "martin_custom_shop_d_42_k_k";
pub const DISPLAY_NAME: &str = "Custom Shop D-42 K&K";
const BRAND: &str = "martin";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        MartinCustomShopD42KKCapture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct MartinCustomShopD42KKCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[MartinCustomShopD42KKCapture] = &[
    capture!("standard", "body/martin_custom_shop_d_42_k_k/leo_martin_d42_knk_44100.wav"),
    capture!("blend", "body/martin_custom_shop_d_42_k_k/leo_martin_d42_knk_44100_bld.wav"),
    capture!("match", "body/martin_custom_shop_d_42_k_k/leo_martin_d42_knk_44100_match.wav"),
    capture!("jf", "body/martin_custom_shop_d_42_k_k/leo_martin_d42_knk_44100_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MartinCustomShopD42KKCapture> {
