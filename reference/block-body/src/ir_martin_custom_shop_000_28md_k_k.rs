...
pub const CAPTURES: &[Capture] = &[
    capture!("00028md_knk_44100", "body/martin_custom_shop_000_28md_k_k/00028md_knk_44100.wav"),
    capture!("00028md_knk_44100_match1", "body/martin_custom_shop_000_28md_k_k/00028md_knk_44100_match1.wav"),
    capture!("jf45ir00028jf", "body/martin_custom_shop_000_28md_k_k/jf45ir00028jf.wav"),
    capture!("jf45ir102400028jf", "body/martin_custom_shop_000_28md_k_k/jf45ir102400028jf.wav"),
    capture!("jf45ir505000028jf", "body/martin_custom_shop_000_28md_k_k/jf45ir505000028jf.wav"),
];
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("00028md_knk_44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
