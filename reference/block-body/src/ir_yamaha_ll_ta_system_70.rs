...
pub const MODEL_ID: &str = "yamaha_ll_ta_system_70";
pub const DISPLAY_NAME: &str = "LL-TA System 70";
const BRAND: &str = "yamaha";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        YamahaLlTaSystem70Capture {
            voicing: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct YamahaLlTaSystem70Capture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[YamahaLlTaSystem70Capture] = &[
    capture!("jf45ir1024yam", "body/yamaha_ll_ta_system_70/jf45ir1024yam.wav"),
    capture!("jf45ir5050yam", "body/yamaha_ll_ta_system_70/jf45ir5050yam.wav"),
    capture!("jf45iryam", "body/yamaha_ll_ta_system_70/jf45iryam.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("jf45iryam"), &[
            ("jf45ir1024yam", "JF45 IR 1024"), ("jf45ir5050yam", "JF45 IR 5050"), ("jf45iryam", "JF45 IR"),
        ])],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static YamahaLlTaSystem70Capture> {
