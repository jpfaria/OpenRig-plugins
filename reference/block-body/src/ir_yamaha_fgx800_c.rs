...
pub const MODEL_ID: &str = "yamaha_fgx800_c";
pub const DISPLAY_NAME: &str = "FGX800C";
const BRAND: &str = "yamaha";
...
pub const CAPTURES: &[Capture] = &[
    capture!("yamaha_fgx800c_48000", "body/yamaha_fgx800_c/yamaha_fgx800c_48000.wav"),
    capture!("yamaha_fgx800c_48000_bld", "body/yamaha_fgx800_c/yamaha_fgx800c_48000_bld.wav"),
    capture!("yamaha_fgx800c_48000_match", "body/yamaha_fgx800_c/yamaha_fgx800c_48000_match.wav"),
    capture!("yamaha_fgx800c_48000_jf_flavor", "body/yamaha_fgx800_c/yamaha_fgx800c_48000_jf_flavor.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("yamaha_fgx800c_48000"), &[
            ("yamaha_fgx800c_48000", "Standard"), ("yamaha_fgx800c_48000_bld", "Blend"), ("yamaha_fgx800c_48000_match", "Match"), ("yamaha_fgx800c_48000_jf_flavor", "JF Flavor"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("yamaha_fgx800c_48000".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
