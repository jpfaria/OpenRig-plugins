...
pub const MODEL_ID: &str = "martin_om_18e";
pub const DISPLAY_NAME: &str = "OM-18E";
...
pub struct MartinOm18eCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[MartinOm18eCapture] = &[
    capture!("standard", "body/martin_om_18e/martin_om_18e_aura_vte_48000.wav"),
    capture!("blend", "body/martin_om_18e/martin_om_18e_aura_vte_48000_bld.wav"),
    capture!("match", "body/martin_om_18e/martin_om_18e_aura_vte_48000_match.wav"),
    capture!("jf", "body/martin_om_18e/martin_om_18e_aura_vte_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MartinOm18eCapture> {
