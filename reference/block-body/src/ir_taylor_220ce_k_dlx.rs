...
pub const MODEL_ID: &str = "taylor_220ce_k_dlx";
pub const DISPLAY_NAME: &str = "220ce K DLX";
const BRAND: &str = "taylor";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        Taylor220ceKDlxCapture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct Taylor220ceKDlxCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[Taylor220ceKDlxCapture] = &[
    capture!("standard", "body/taylor_220ce_k_dlx/taylor_220ce_k_dlx_48000.wav"),
    capture!("blend", "body/taylor_220ce_k_dlx/taylor_220ce_k_dlx_48000_bld.wav"),
    capture!("match", "body/taylor_220ce_k_dlx/taylor_220ce_k_dlx_48000_match.wav"),
    capture!("jf", "body/taylor_220ce_k_dlx/taylor_220ce_k_dlx_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Taylor220ceKDlxCapture> {
