...
pub const CAPTURES: &[Capture] = &[
    capture!("ir_breedlove_ad25sr_plus_sm44100", "body/tk_breedlove_ad25_srplus_fishman/ir_breedlove_ad25sr_plus_sm44100.wav"),
    capture!("ir_breedlove_ad25sr_plus_sm44100_match1", "body/tk_breedlove_ad25_srplus_fishman/ir_breedlove_ad25sr_plus_sm44100_match1.wav"),
    capture!("ir_breedlove_ad25sr_plus_bb44100", "body/tk_breedlove_ad25_srplus_fishman/ir_breedlove_ad25sr_plus_bb44100.wav"),
    capture!("ir_breedlove_ad25sr_plus_bb44100_match1", "body/tk_breedlove_ad25_srplus_fishman/ir_breedlove_ad25sr_plus_bb44100_match1.wav"),
    capture!("ir_breedlove_ad25sr_plus_bb44100_match2", "body/tk_breedlove_ad25_srplus_fishman/ir_breedlove_ad25sr_plus_bb44100_match2.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("ir_breedlove_ad25sr_plus_sm44100"), &[
            ("ir_breedlove_ad25sr_plus_sm44100", "SM Standard"), ("ir_breedlove_ad25sr_plus_sm44100_match1", "SM Match 1"),
            ("ir_breedlove_ad25sr_plus_bb44100", "BB Standard"), ("ir_breedlove_ad25sr_plus_bb44100_match1", "BB Match 1"), ("ir_breedlove_ad25sr_plus_bb44100_match2", "BB Match 2"),
        ])],
    }
}
