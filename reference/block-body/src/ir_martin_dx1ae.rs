...
pub const MODEL_ID: &str = "martin_dx1ae";
pub const DISPLAY_NAME: &str = "DX1AE";
...
pub struct MartinDx1aeCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[MartinDx1aeCapture] = &[
    capture!("kb_dx1ae_9_48k", "body/martin_dx1ae/kb_dx1ae_9_48k.wav"),
    capture!("kb_dx1ae_9_48k_mffqn", "body/martin_dx1ae/kb_dx1ae_9_48k_mffqn.wav"),
    capture!("kb_dx1ae_9_48k_m", "body/martin_dx1ae/kb_dx1ae_9_48k_m.wav"),
    capture!("kb_dx1ae_18_48k_m", "body/martin_dx1ae/kb_dx1ae_18_48k_m.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter(
            ...
            Some("kb_dx1ae_9_48k"),
            &[
                ("kb_dx1ae_9_48k", "KB DX1AE 9 48K"),
                ("kb_dx1ae_9_48k_mffqn", "KB DX1AE 9 48K MFFQN"),
                ("kb_dx1ae_9_48k_m", "KB DX1AE 9 48K M"),
                ("kb_dx1ae_18_48k_m", "KB DX1AE 18 48K M"),
            ],
        )],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MartinDx1aeCapture> {
