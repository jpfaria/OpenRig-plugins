...
pub struct LowdenPierreBensusanTheOldLadyKkCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[LowdenPierreBensusanTheOldLadyKkCapture] = &[
    capture!("ir_lowden_old_lady_48k", "body/lowden_pierre_bensusan_the_old_lady_kk/ir_lowden_old_lady_48k.wav"),
    capture!("ir_lowden_old_lady_48k_m", "body/lowden_pierre_bensusan_the_old_lady_kk/ir_lowden_old_lady_48k_m.wav"),
    capture!("ir_lowden_old_lady_48k_mffqn", "body/lowden_pierre_bensusan_the_old_lady_kk/ir_lowden_old_lady_48k_mffqn.wav"),
];
