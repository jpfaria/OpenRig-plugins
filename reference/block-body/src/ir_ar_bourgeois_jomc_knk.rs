...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("bourgeois_jomc_knk_44100"), &[
            ("bourgeois_jomc_knk_44100", "44100"),
            ("bourgeois_jomc_knk_44100_match1", "44100 Match 1"),
            ("bourgeois_jomc_knk_44100_match2", "44100 Match 2"),
        ])],
    }
}
