...
pub struct EmeraldX30BarberaSoloistCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[EmeraldX30BarberaSoloistCapture] = &[
    capture!("jf45ir1024x30", "body/emerald_x30_barbera_soloist/jf45ir1024x30.wav"),
    capture!("jf45ir5050x30", "body/emerald_x30_barbera_soloist/jf45ir5050x30.wav"),
    capture!("jf45irx30", "body/emerald_x30_barbera_soloist/jf45irx30.wav"),
];
