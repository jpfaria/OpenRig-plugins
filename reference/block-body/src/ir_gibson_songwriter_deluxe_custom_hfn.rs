...
pub const MODEL_ID: &str = "gibson_songwriter_deluxe_custom_hfn";
pub const DISPLAY_NAME: &str = "Songwriter Deluxe Custom HFN";
const BRAND: &str = "gibson";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        GibsonSongwriterDeluxeCustomHfnCapture {
            voicing: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct GibsonSongwriterDeluxeCustomHfnCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[GibsonSongwriterDeluxeCustomHfnCapture] = &[
    capture!("jf45ir1024gibson", "body/gibson_songwriter_deluxe_custom_hfn/jf45ir1024gibson.wav"),
    capture!("jf45ir5050gibson", "body/gibson_songwriter_deluxe_custom_hfn/jf45ir5050gibson.wav"),
    capture!("jf45irgibson", "body/gibson_songwriter_deluxe_custom_hfn/jf45irgibson.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("jf45irgibson"), &[
            ("jf45ir1024gibson", "JF45 IR 1024"), ("jf45ir5050gibson", "JF45 IR 5050"), ("jf45irgibson", "JF45 IR"),
        ])],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static GibsonSongwriterDeluxeCustomHfnCapture> {
