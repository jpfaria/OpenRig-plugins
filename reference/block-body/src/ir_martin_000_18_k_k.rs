...
pub const MODEL_ID: &str = "martin_000_18_k_k";
pub const DISPLAY_NAME: &str = "000-18 K&K";
...
pub const CAPTURES: &[Capture] = &[
    capture!("sc_martin_000_18_knk1_44100", "body/martin_000_18_k_k/sc_martin_000_18_knk1_44100.wav"),
    capture!("sc_martin_000_18_knk1_44100_bld", "body/martin_000_18_k_k/sc_martin_000_18_knk1_44100_bld.wav"),
    capture!("sc_martin_000_18_knk1_44100_match", "body/martin_000_18_k_k/sc_martin_000_18_knk1_44100_match.wav"),
    capture!("sc_martin_000_18_knk1_44100_jf_flavor", "body/martin_000_18_k_k/sc_martin_000_18_knk1_44100_jf_flavor.wav"),
    capture!("sc_martin_000_18_knk2_44100", "body/martin_000_18_k_k/sc_martin_000_18_knk2_44100.wav"),
    capture!("sc_martin_000_18_knk2_44100_bld", "body/martin_000_18_k_k/sc_martin_000_18_knk2_44100_bld.wav"),
    capture!("sc_martin_000_18_knk2_44100_jf_flavor", "body/martin_000_18_k_k/sc_martin_000_18_knk2_44100_jf_flavor.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("sc_martin_000_18_knk1_44100"), &[
            ("sc_martin_000_18_knk1_44100", "K&K 1"), ("sc_martin_000_18_knk1_44100_bld", "K&K 1 Blend"), ("sc_martin_000_18_knk1_44100_match", "K&K 1 Match"), ("sc_martin_000_18_knk1_44100_jf_flavor", "K&K 1 JF Flavor"),
            ("sc_martin_000_18_knk2_44100", "K&K 2"), ("sc_martin_000_18_knk2_44100_bld", "K&K 2 Blend"), ("sc_martin_000_18_knk2_44100_jf_flavor", "K&K 2 JF Flavor"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("sc_martin_000_18_knk1_44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
