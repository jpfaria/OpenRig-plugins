...
pub const MODEL_ID: &str = "taylor_614ce";
pub const DISPLAY_NAME: &str = "614ce";
...
pub struct Taylor614ceCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[Taylor614ceCapture] = &[
    capture!("standard", "body/taylor_614ce/taylor_614ce_48000.wav"),
    capture!("blend", "body/taylor_614ce/taylor_614ce_48000_bld.wav"),
    capture!("match", "body/taylor_614ce/taylor_614ce_48000_match.wav"),
    capture!("jf", "body/taylor_614ce/taylor_614ce_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Taylor614ceCapture> {
