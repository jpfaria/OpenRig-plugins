...
pub const MODEL_ID: &str = "martin_dc_16e_matrix_vte";
pub const DISPLAY_NAME: &str = "DC-16E Matrix VTE";
const BRAND: &str = "martin";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        MartinDc16eMatrixVteCapture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct MartinDc16eMatrixVteCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[MartinDc16eMatrixVteCapture] = &[
    capture!("standard", "body/martin_dc_16e_matrix_vte/martin_dc_16e_48000.wav"),
    capture!("blend", "body/martin_dc_16e_matrix_vte/martin_dc_16e_48000_bld.wav"),
    capture!("match", "body/martin_dc_16e_matrix_vte/martin_dc_16e_48000_match.wav"),
    capture!("jf", "body/martin_dc_16e_matrix_vte/martin_dc_16e_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MartinDc16eMatrixVteCapture> {
