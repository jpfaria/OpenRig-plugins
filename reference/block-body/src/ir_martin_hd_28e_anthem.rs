...
pub const MODEL_ID: &str = "martin_hd_28e_anthem";
pub const DISPLAY_NAME: &str = "HD-28E Anthem";
const BRAND: &str = "martin";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        MartinHd28eAnthemCapture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct MartinHd28eAnthemCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[MartinHd28eAnthemCapture] = &[
    capture!("standard", "body/martin_hd_28e_anthem/martin_hd_28e_anthem_48000.wav"),
    capture!("blend", "body/martin_hd_28e_anthem/martin_hd_28e_anthem_48000_bld.wav"),
    capture!("match", "body/martin_hd_28e_anthem/martin_hd_28e_anthem_48000_match.wav"),
    capture!("jf", "body/martin_hd_28e_anthem/martin_hd_28e_anthem_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MartinHd28eAnthemCapture> {
