...
pub struct AsMartinOm28Capture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[AsMartinOm28Capture] = &[
    capture!("as_om28_matrix_44100", "body/as_martin_om28/as_om28_matrix_44100.wav"),
    capture!("as_om28_matrix_44100_bld", "body/as_martin_om28/as_om28_matrix_44100_bld.wav"),
    capture!("as_om28_matrix_44100_jf_flavor", "body/as_martin_om28/as_om28_matrix_44100_jf_flavor.wav"),
    capture!("as_om28_matrix_44100_match", "body/as_martin_om28/as_om28_matrix_44100_match.wav"),
];
