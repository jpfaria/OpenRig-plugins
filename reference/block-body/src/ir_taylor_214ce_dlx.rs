...
pub const MODEL_ID: &str = "taylor_214ce_dlx";
pub const DISPLAY_NAME: &str = "214ce DLX";
const BRAND: &str = "taylor";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        Taylor214ceDlxCapture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct Taylor214ceDlxCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[Taylor214ceDlxCapture] = &[
    capture!("standard", "body/taylor_214ce_dlx/taylor_214ce_dlx_48000.wav"),
    capture!("blend", "body/taylor_214ce_dlx/taylor_214ce_dlx_48000_bld.wav"),
    capture!("match", "body/taylor_214ce_dlx/taylor_214ce_dlx_48000_match.wav"),
    capture!("jf", "body/taylor_214ce_dlx/taylor_214ce_dlx_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Taylor214ceDlxCapture> {
