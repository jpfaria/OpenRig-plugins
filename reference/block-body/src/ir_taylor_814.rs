...
pub const MODEL_ID: &str = "taylor_814";
pub const DISPLAY_NAME: &str = "814";
...
pub struct Taylor814Capture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[Taylor814Capture] = &[
    capture!("dpa_4011", "body/taylor_814/taylor_814_dpa_4011.wav"),
    capture!("neumann_u87", "body/taylor_814/taylor_814_neumann_u87.wav"),
    capture!("shure_sm57", "body/taylor_814/taylor_814_shure_sm57.wav"),
    capture!("neumann_km84", "body/taylor_814/taylor_814_neumann_km84.wav"),
];
    ...
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter(
            ...
            &[
                ...
                ("shure_sm57", "Shure SM57"),
                ("neumann_km84", "Neumann KM84"),
            ],
        )],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Taylor814Capture> {
