...
pub const MODEL_ID: &str = "hamblin_gc_barbera";
pub const DISPLAY_NAME: &str = "GC Barbera";
...
pub const CAPTURES: &[Capture] = &[
    capture!("dy", "body/hamblin_gc_barbera/dy.wav"),
    capture!("cukiir2048at48", "body/hamblin_gc_barbera/cukiir2048at48.wav"),
    capture!("cukijfir2048at48", "body/hamblin_gc_barbera/cukijfir2048at48.wav"),
    capture!("jf45irdy", "body/hamblin_gc_barbera/jf45irdy.wav"),
    capture!("jf45ir1024dy", "body/hamblin_gc_barbera/jf45ir1024dy.wav"),
    capture!("jf45ir5050dy", "body/hamblin_gc_barbera/jf45ir5050dy.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("dy"), &[
            ("dy", "Standard"), ("cukiir2048at48", "Cuki IR 2048"), ("cukijfir2048at48", "Cuki JF IR 2048"),
            ("jf45irdy", "JF45 IR"), ("jf45ir1024dy", "JF45 IR 1024"), ("jf45ir5050dy", "JF45 IR 5050"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("dy".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
