...
pub struct MerillOm28DazzoCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[MerillOm28DazzoCapture] = &[
    capture!("ir_merill_om28_dazzo_44100", "body/merill_om_28_dazzo/ir_merill_om28_dazzo_44100.wav"),
    capture!("ir_merill_om28_dazzo_44100_match2", "body/merill_om_28_dazzo/ir_merill_om28_dazzo_44100_match2.wav"),
    capture!("ir_merill_om28_dazzo_44100_match2_lessroom", "body/merill_om_28_dazzo/ir_merill_om28_dazzo_44100_match2_lessroom.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("ir_merill_om28_dazzo_44100"), &[
            ("ir_merill_om28_dazzo_44100", "44100"),
            ("ir_merill_om28_dazzo_44100_match2", "44100 Match 2"),
            ("ir_merill_om28_dazzo_44100_match2_lessroom", "44100 Match 2 Less Room"),
        ])],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MerillOm28DazzoCapture> {
