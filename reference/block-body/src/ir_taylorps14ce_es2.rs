...
pub const MODEL_ID: &str = "taylorps14ce_es2";
pub const DISPLAY_NAME: &str = "PS14ce ES2";
const BRAND: &str = "taylor";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        Taylorps14ceEs2Capture {
            voicing: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct Taylorps14ceEs2Capture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[Taylorps14ceEs2Capture] = &[
    capture!("ps14e_2048_44k", "body/taylorps14ce_es2/ps14e_2048_44k.wav"),
    capture!("ps14e_2048_44k_m", "body/taylorps14ce_es2/ps14e_2048_44k_m.wav"),
    capture!("ps14e_2048_48k_mffqn", "body/taylorps14ce_es2/ps14e_2048_48k_mffqn.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("ps14e_2048_44k"), &[
            ("ps14e_2048_44k", "2048 44k"), ("ps14e_2048_44k_m", "2048 44k M"), ("ps14e_2048_48k_mffqn", "2048 48k MFFQN"),
        ])],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Taylorps14ceEs2Capture> {
