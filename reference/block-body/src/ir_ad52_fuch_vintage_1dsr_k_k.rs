...
pub struct Ad52FuchVintage1dsrKKCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[Ad52FuchVintage1dsrKKCapture] = &[
    capture!("furch_vintage1d_sr_48k", "body/ad52_fuch_vintage_1dsr_k_k/furch_vintage1d_sr_48k.wav"),
    capture!("furch_vintage1d_sr_48k_m", "body/ad52_fuch_vintage_1dsr_k_k/furch_vintage1d_sr_48k_m.wav"),
    capture!("furch_vintage1d_sr_48k_m_ffq", "body/ad52_fuch_vintage_1dsr_k_k/furch_vintage1d_sr_48k_m_ffq.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("furch_vintage1d_sr_48k"), &[
            ("furch_vintage1d_sr_48k", "48k"), ("furch_vintage1d_sr_48k_m", "48k M"), ("furch_vintage1d_sr_48k_m_ffq", "48k M FFQ"),
        ])],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Ad52FuchVintage1dsrKKCapture> {
