...
pub const MODEL_ID: &str = "as_martin_d35sa";
pub const DISPLAY_NAME: &str = "D-35 SA";
const BRAND: &str = "martin";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        AsMartinD35saCapture {
            voicing: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct AsMartinD35saCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[AsMartinD35saCapture] = &[
    capture!("as_martin_d35sa_gplus_44100", "body/as_martin_d35sa/as_martin_d35sa_gplus_44100.wav"),
    capture!("as_martin_d35sa_gplus_44100_bld", "body/as_martin_d35sa/as_martin_d35sa_gplus_44100_bld.wav"),
    capture!("as_martin_d35sa_gplus_44100_jf_flavor", "body/as_martin_d35sa/as_martin_d35sa_gplus_44100_jf_flavor.wav"),
    capture!("as_martin_d35sa_gplus_44100_match", "body/as_martin_d35sa/as_martin_d35sa_gplus_44100_match.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("as_martin_d35sa_gplus_44100_bld"), &[
            ("as_martin_d35sa_gplus_44100", "G+ 44100"), ("as_martin_d35sa_gplus_44100_bld", "G+ 44100 Bld"),
            ("as_martin_d35sa_gplus_44100_jf_flavor", "G+ 44100 JF Flavor"), ("as_martin_d35sa_gplus_44100_match", "G+ 44100 Match"),
        ])],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static AsMartinD35saCapture> {
