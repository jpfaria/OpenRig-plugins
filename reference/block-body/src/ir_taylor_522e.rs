...
pub const MODEL_ID: &str = "taylor_522e";
pub const DISPLAY_NAME: &str = "522e";
...
pub struct Taylor522eCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[Taylor522eCapture] = &[
    capture!("taylor522e_44100", "body/taylor_522e/taylor522e_44100.wav"),
    capture!("taylor522e_44100_match1", "body/taylor_522e/taylor522e_44100_match1.wav"),
    capture!("taylor522e_44100_match2", "body/taylor_522e/taylor522e_44100_match2.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("taylor522e_44100"), &[
            ("taylor522e_44100", "44100"), ("taylor522e_44100_match1", "44100 Match 1"), ("taylor522e_44100_match2", "44100 Match 2"),
        ])],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Taylor522eCapture> {
