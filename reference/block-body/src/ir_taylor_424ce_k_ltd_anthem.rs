...
pub const MODEL_ID: &str = "taylor_424ce_k_ltd_anthem";
pub const DISPLAY_NAME: &str = "424ce-K LTD Anthem";
const BRAND: &str = "taylor";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        Taylor424ceKLtdAnthemCapture {
            voicing: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct Taylor424ceKLtdAnthemCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[Taylor424ceKLtdAnthemCapture] = &[
    capture!("ir2_424_44k_2048", "body/taylor_424ce_k_ltd_anthem/ir2_424_44k_2048.wav"),
    capture!("ir2_424_44k_2048_m2", "body/taylor_424ce_k_ltd_anthem/ir2_424_44k_2048_m2.wav"),
    capture!("ir2_424_44k_2048_mffq3n", "body/taylor_424ce_k_ltd_anthem/ir2_424_44k_2048_mffq3n.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("ir2_424_44k_2048"), &[
            ("ir2_424_44k_2048", "44k 2048"), ("ir2_424_44k_2048_m2", "44k 2048 M2"), ("ir2_424_44k_2048_mffq3n", "44k 2048 MFFQ3N"),
        ])],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Taylor424ceKLtdAnthemCapture> {
