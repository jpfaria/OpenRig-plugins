...
pub const MODEL_ID: &str = "mcpherson_camrielle";
pub const DISPLAY_NAME: &str = "Camrielle";
const BRAND: &str = "mcpherson";
...
pub const CAPTURES: &[Capture] = &[
    capture!("holy_grail_c800_exp", "body/mcpherson_camrielle/holy_grail_c800_exp.wav"),
    capture!("holy_grail_c800_pz1", "body/mcpherson_camrielle/holy_grail_c800_pz1.wav"),
    capture!("holy_grail_c800_pz2", "body/mcpherson_camrielle/holy_grail_c800_pz2.wav"),
    capture!("holy_grail_c800_pz3", "body/mcpherson_camrielle/holy_grail_c800_pz3.wav"),
    capture!("holy_grail_c800_sb1", "body/mcpherson_camrielle/holy_grail_c800_sb1.wav"),
    capture!("holy_grail_c800_sb2", "body/mcpherson_camrielle/holy_grail_c800_sb2.wav"),
    capture!("holy_grail_c800_sb3_blend", "body/mcpherson_camrielle/holy_grail_c800_sb3_blend.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("holy_grail_c800_exp"), &[
            ("holy_grail_c800_exp", "Expression"), ("holy_grail_c800_pz1", "Piezo 1"), ("holy_grail_c800_pz2", "Piezo 2"), ("holy_grail_c800_pz3", "Piezo 3"),
            ("holy_grail_c800_sb1", "Soundboard 1"), ("holy_grail_c800_sb2", "Soundboard 2"), ("holy_grail_c800_sb3_blend", "Soundboard 3 Blend"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("holy_grail_c800_exp".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
