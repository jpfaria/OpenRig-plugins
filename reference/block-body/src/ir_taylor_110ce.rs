...
pub const CAPTURES: &[Taylor110ceCapture] = &[
    capture!("standard", "body/taylor_110ce/taylor_110ce_48000.wav"),
    capture!("blend", "body/taylor_110ce/taylor_110ce_48000_bld.wav"),
    capture!("match", "body/taylor_110ce/taylor_110ce_48000_match.wav"),
    capture!("jf", "body/taylor_110ce/taylor_110ce_48000_jf_flavor.wav"),
];
