...
pub const MODEL_ID: &str = "taylor_814ce_dlx";
pub const DISPLAY_NAME: &str = "814ce DLX";
const BRAND: &str = "taylor";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        Taylor814ceDlxCapture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct Taylor814ceDlxCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[Taylor814ceDlxCapture] = &[
    capture!("standard", "body/taylor_814ce_dlx/taylor_814ce_dlx_48000.wav"),
    capture!("blend", "body/taylor_814ce_dlx/taylor_814ce_dlx_48000_bld.wav"),
    capture!("match", "body/taylor_814ce_dlx/taylor_814ce_dlx_48000_match.wav"),
    capture!("jf", "body/taylor_814ce_dlx/taylor_814ce_dlx_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Taylor814ceDlxCapture> {
