...
pub const MODEL_ID: &str = "taylor_114ce";
pub const DISPLAY_NAME: &str = "114ce";
...
pub struct Taylor114ceCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[Taylor114ceCapture] = &[
    capture!("standard", "body/taylor_114ce/taylor_114ce_48000.wav"),
    capture!("blend", "body/taylor_114ce/taylor_114ce_48000_bld.wav"),
    capture!("match", "body/taylor_114ce/taylor_114ce_48000_match.wav"),
    capture!("jf", "body/taylor_114ce/taylor_114ce_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Taylor114ceCapture> {
