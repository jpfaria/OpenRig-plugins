...
pub const CAPTURES: &[Capture] = &[
    capture!("lescotton_westfield", "body/les_cotton_westfield/lescotton_westfield.wav"),
    capture!("cukiirlescottonwest2048_48", "body/les_cotton_westfield/cukiirlescottonwest2048_48.wav"),
    capture!("cukijfirlescottonwest2048at48", "body/les_cotton_westfield/cukijfirlescottonwest2048at48.wav"),
    capture!("jf45irlescotton_westfield", "body/les_cotton_westfield/jf45irlescotton_westfield.wav"),
    capture!("jf45ir1024lescotton_westfield", "body/les_cotton_westfield/jf45ir1024lescotton_westfield.wav"),
    capture!("jf45ir5050lescotton_westfield", "body/les_cotton_westfield/jf45ir5050lescotton_westfield.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("lescotton_westfield"), &[
            ("lescotton_westfield", "Standard"), ("cukiirlescottonwest2048_48", "Cuki IR 2048"), ("cukijfirlescottonwest2048at48", "Cuki JF IR 2048"),
            ("jf45irlescotton_westfield", "JF45 IR"), ("jf45ir1024lescotton_westfield", "JF45 IR 1024"), ("jf45ir5050lescotton_westfield", "JF45 IR 5050"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("lescotton_westfield".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
