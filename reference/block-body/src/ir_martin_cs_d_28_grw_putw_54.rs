...
pub const MODEL_ID: &str = "martin_cs_d_28_grw_putw_54";
pub const DISPLAY_NAME: &str = "CS D-28 GRW PUTW 54";
const BRAND: &str = "martin";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        MartinCsD28GrwPutw54Capture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct MartinCsD28GrwPutw54Capture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[MartinCsD28GrwPutw54Capture] = &[
    capture!("standard", "body/martin_cs_d_28_grw_putw_54/martin_cs_d28grw_putw_44100.wav"),
    capture!("blend", "body/martin_cs_d_28_grw_putw_54/martin_cs_d28grw_putw_44100_bld.wav"),
    capture!("match", "body/martin_cs_d_28_grw_putw_54/martin_cs_d28grw_putw_44100_match.wav"),
    capture!("jf", "body/martin_cs_d_28_grw_putw_54/martin_cs_d28grw_putw_44100_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MartinCsD28GrwPutw54Capture> {
