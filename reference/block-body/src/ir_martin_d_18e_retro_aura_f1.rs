...
pub const MODEL_ID: &str = "martin_d_18e_retro_aura_f1";
pub const DISPLAY_NAME: &str = "D-18E Retro Aura F1";
const BRAND: &str = "martin";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        MartinD18eRetroAuraF1Capture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct MartinD18eRetroAuraF1Capture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[MartinD18eRetroAuraF1Capture] = &[
    capture!("standard", "body/martin_d_18e_retro_aura_f1/martin_d_18e_retro_48000.wav"),
    capture!("blend", "body/martin_d_18e_retro_aura_f1/martin_d_18e_retro_48000_bld.wav"),
    capture!("match", "body/martin_d_18e_retro_aura_f1/martin_d_18e_retro_48000_match.wav"),
    capture!("jf", "body/martin_d_18e_retro_aura_f1/martin_d_18e_retro_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MartinD18eRetroAuraF1Capture> {
