...
pub const MODEL_ID: &str = "martin_omc_16e_matrix_vte";
pub const DISPLAY_NAME: &str = "OMC-16E Matrix VTE";
const BRAND: &str = "martin";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        MartinOmc16eMatrixVteCapture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct MartinOmc16eMatrixVteCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[MartinOmc16eMatrixVteCapture] = &[
    capture!("standard", "body/martin_omc_16e_matrix_vte/martin_omc_16e_48000.wav"),
    capture!("blend", "body/martin_omc_16e_matrix_vte/martin_omc_16e_48000_bld.wav"),
    capture!("match", "body/martin_omc_16e_matrix_vte/martin_omc_16e_48000_match.wav"),
    capture!("jf", "body/martin_omc_16e_matrix_vte/martin_omc_16e_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MartinOmc16eMatrixVteCapture> {
