...
pub const MODEL_ID: &str = "alvarez_abt60_baritone";
pub const DISPLAY_NAME: &str = "ABT60 Baritone";
const BRAND: &str = "alvarez";
...
pub const CAPTURES: &[Capture] = &[
    capture!("ir_alvarez_abt_60_baritone_sm44100", "body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_sm44100.wav"),
    capture!("ir_alvarez_abt_60_baritone_sm44100_match1", "body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_sm44100_match1.wav"),
    capture!("ir_alvarez_abt_60_baritone_sm44100_match2", "body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_sm44100_match2.wav"),
    capture!("ir_alvarez_abt_60_baritone_bb44100", "body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_bb44100.wav"),
    capture!("ir_alvarez_abt_60_baritone_bb44100_match1", "body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_bb44100_match1.wav"),
    capture!("ir_alvarez_abt_60_baritone_bb44100_match2", "body/alvarez_abt60_baritone/ir_alvarez_abt_60_baritone_bb44100_match2.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("ir_alvarez_abt_60_baritone_sm44100"), &[
            ("ir_alvarez_abt_60_baritone_sm44100", "SM Standard"), ("ir_alvarez_abt_60_baritone_sm44100_match1", "SM Match 1"), ("ir_alvarez_abt_60_baritone_sm44100_match2", "SM Match 2"),
            ("ir_alvarez_abt_60_baritone_bb44100", "BB Standard"), ("ir_alvarez_abt_60_baritone_bb44100_match1", "BB Match 1"), ("ir_alvarez_abt_60_baritone_bb44100_match2", "BB Match 2"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("ir_alvarez_abt_60_baritone_sm44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
