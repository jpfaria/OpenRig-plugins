...
pub const MODEL_ID: &str = "martin_djr_10e";
pub const DISPLAY_NAME: &str = "DJR-10E";
...
pub struct MartinDjr10eCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[MartinDjr10eCapture] = &[
    capture!("standard", "body/martin_djr_10e/martin_djr_10e_48000.wav"),
    capture!("blend", "body/martin_djr_10e/martin_djr_10e_48000_bld.wav"),
    capture!("match", "body/martin_djr_10e/martin_djr_10e_48000_match.wav"),
    capture!("jf", "body/martin_djr_10e/martin_djr_10e_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MartinDjr10eCapture> {
