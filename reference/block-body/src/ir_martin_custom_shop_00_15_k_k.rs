...
pub const MODEL_ID: &str = "martin_custom_shop_00_15_k_k";
pub const DISPLAY_NAME: &str = "Custom Shop 00-15 K&K";
...
pub const CAPTURES: &[Capture] = &[
    capture!("cs_0015_knk_44100", "body/martin_custom_shop_00_15_k_k/cs_0015_knk_44100.wav"),
    capture!("cs_0015_knk_44100_match2", "body/martin_custom_shop_00_15_k_k/cs_0015_knk_44100_match2.wav"),
    capture!("jf45ircs0015jf", "body/martin_custom_shop_00_15_k_k/jf45ircs0015jf.wav"),
    capture!("jf45ir1024cs0015jf", "body/martin_custom_shop_00_15_k_k/jf45ir1024cs0015jf.wav"),
    capture!("jf45ir5050cs0015jf", "body/martin_custom_shop_00_15_k_k/jf45ir5050cs0015jf.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("cs_0015_knk_44100"), &[
            ("cs_0015_knk_44100", "Standard"), ("cs_0015_knk_44100_match2", "Match 2"),
            ("jf45ircs0015jf", "JF45 IR"), ("jf45ir1024cs0015jf", "JF45 IR 1024"), ("jf45ir5050cs0015jf", "JF45 IR 5050"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("cs_0015_knk_44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
