...
pub const MODEL_ID: &str = "taylor_414ce";
pub const DISPLAY_NAME: &str = "414ce";
...
pub struct Taylor414ceCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[Taylor414ceCapture] = &[
    capture!("standard", "body/taylor_414ce/taylor_414ce_48000.wav"),
    capture!("blend", "body/taylor_414ce/taylor_414ce_48000_bld.wav"),
    capture!("match", "body/taylor_414ce/taylor_414ce_48000_match.wav"),
    capture!("jf", "body/taylor_414ce/taylor_414ce_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Taylor414ceCapture> {
