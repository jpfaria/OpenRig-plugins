...
pub const MODEL_ID: &str = "martin_000_17e_matrix_vte";
pub const DISPLAY_NAME: &str = "000-17E Matrix VTE";
const BRAND: &str = "martin";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        Martin00017eMatrixVteCapture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct Martin00017eMatrixVteCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[Martin00017eMatrixVteCapture] = &[
    capture!("standard", "body/martin_000_17e_matrix_vte/martin_000_17e_48000.wav"),
    capture!("blend", "body/martin_000_17e_matrix_vte/martin_000_17e_48000_bld.wav"),
    capture!("match", "body/martin_000_17e_matrix_vte/martin_000_17e_48000_match.wav"),
    capture!("jf", "body/martin_000_17e_matrix_vte/martin_000_17e_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Martin00017eMatrixVteCapture> {
