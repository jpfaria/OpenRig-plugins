...
pub const MODEL_ID: &str = "taylor_510e";
pub const DISPLAY_NAME: &str = "510e";
...
pub struct Taylor510eCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[Taylor510eCapture] = &[
    capture!("standard", "body/taylor_510e/taylor_510e_xbraced_48000.wav"),
    capture!("blend", "body/taylor_510e/taylor_510e_xbraced_48000_bld.wav"),
    capture!("match", "body/taylor_510e/taylor_510e_xbraced_48000_match.wav"),
    capture!("jf", "body/taylor_510e/taylor_510e_xbraced_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Taylor510eCapture> {
