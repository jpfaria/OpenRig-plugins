...
pub const MODEL_ID: &str = "bc_rich_sonitone_2";
pub const DISPLAY_NAME: &str = "Sonitone 2";
...
pub const CAPTURES: &[Capture] = &[
    capture!("bc_rich_plywood_sonitone_44100", "body/bc_rich_sonitone_2/bc_rich_plywood_sonitone_44100.wav"),
    capture!("bc_rich_plywood_sonitone_44100_match1", "body/bc_rich_sonitone_2/bc_rich_plywood_sonitone_44100_match1.wav"),
    capture!("bc_rich_plywood_sonitone_44100_match2", "body/bc_rich_sonitone_2/bc_rich_plywood_sonitone_44100_match2.wav"),
    capture!("cukiirpwfs2048at48", "body/bc_rich_sonitone_2/cukiirpwfs2048at48.wav"),
    capture!("cukijfirpwfs2048at48", "body/bc_rich_sonitone_2/cukijfirpwfs2048at48.wav"),
    capture!("jf45irpwfs", "body/bc_rich_sonitone_2/jf45irpwfs.wav"),
    capture!("jf45ir1024pwfs", "body/bc_rich_sonitone_2/jf45ir1024pwfs.wav"),
    capture!("jf45ir5050pwfs", "body/bc_rich_sonitone_2/jf45ir5050pwfs.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("bc_rich_plywood_sonitone_44100"), &[
            ("bc_rich_plywood_sonitone_44100", "Standard"), ("bc_rich_plywood_sonitone_44100_match1", "Match 1"), ("bc_rich_plywood_sonitone_44100_match2", "Match 2"),
            ("cukiirpwfs2048at48", "Cuki IR 2048"), ("cukijfirpwfs2048at48", "Cuki JF IR 2048"),
            ("jf45irpwfs", "JF45 IR"), ("jf45ir1024pwfs", "JF45 IR 1024"), ("jf45ir5050pwfs", "JF45 IR 5050"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("bc_rich_plywood_sonitone_44100".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
