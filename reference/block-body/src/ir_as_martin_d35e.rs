...
pub const MODEL_ID: &str = "as_martin_d35e";
pub const DISPLAY_NAME: &str = "D-35E";
...
pub struct AsMartinD35eCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[AsMartinD35eCapture] = &[
    capture!("as_martin_d35e_fishman_48000", "body/as_martin_d35e/as_martin_d35e_fishman_48000.wav"),
    capture!("as_martin_d35e_fishman_48000_bld", "body/as_martin_d35e/as_martin_d35e_fishman_48000_bld.wav"),
    capture!("as_martin_d35e_fishman_48000_jf_flavor", "body/as_martin_d35e/as_martin_d35e_fishman_48000_jf_flavor.wav"),
    capture!("as_martin_d35e_fishman_48000_match", "body/as_martin_d35e/as_martin_d35e_fishman_48000_match.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("as_martin_d35e_fishman_48000_bld"), &[
            ("as_martin_d35e_fishman_48000", "Fishman 48000"), ("as_martin_d35e_fishman_48000_bld", "Fishman 48000 Bld"),
            ("as_martin_d35e_fishman_48000_jf_flavor", "Fishman 48000 JF Flavor"), ("as_martin_d35e_fishman_48000_match", "Fishman 48000 Match"),
        ])],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static AsMartinD35eCapture> {
