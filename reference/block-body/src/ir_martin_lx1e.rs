...
pub const MODEL_ID: &str = "martin_lx1e";
pub const DISPLAY_NAME: &str = "LX1E";
...
pub struct MartinLx1eCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[MartinLx1eCapture] = &[
    capture!("standard", "body/martin_lx1e/martin_lx1e_sonitone_48000.wav"),
    capture!("blend", "body/martin_lx1e/martin_lx1e_sonitone_48000_bld.wav"),
    capture!("match", "body/martin_lx1e/martin_lx1e_sonitone_48000_match.wav"),
    capture!("jf", "body/martin_lx1e/martin_lx1e_sonitone_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MartinLx1eCapture> {
