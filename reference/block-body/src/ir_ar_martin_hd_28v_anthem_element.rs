...
pub const MODEL_ID: &str = "ar_martin_hd_28v_anthem_element";
pub const DISPLAY_NAME: &str = "HD-28V Anthem Element";
const BRAND: &str = "martin";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        ArMartinHd28vAnthemElementCapture {
            voicing: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct ArMartinHd28vAnthemElementCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[ArMartinHd28vAnthemElementCapture] = &[
    capture!("martin_hd28v_anthem_element_44100", "body/ar_martin_hd_28v_anthem_element/martin_hd28v_anthem_element_44100.wav"),
    capture!("martin_hd28v_anthem_element_44100_match1", "body/ar_martin_hd_28v_anthem_element/martin_hd28v_anthem_element_44100_match1.wav"),
    capture!("martin_hd28v_anthem_element_44100_match2", "body/ar_martin_hd_28v_anthem_element/martin_hd28v_anthem_element_44100_match2.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("martin_hd28v_anthem_element_44100"), &[
            ("martin_hd28v_anthem_element_44100", "44100"),
            ("martin_hd28v_anthem_element_44100_match1", "44100 Match 1"),
            ("martin_hd28v_anthem_element_44100_match2", "44100 Match 2"),
        ])],
    }
}
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static ArMartinHd28vAnthemElementCapture> {
