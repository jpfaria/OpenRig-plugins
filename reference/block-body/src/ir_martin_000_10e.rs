...
pub const MODEL_ID: &str = "martin_000_10e";
pub const DISPLAY_NAME: &str = "000-10E";
...
pub struct Martin00010eCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[Martin00010eCapture] = &[
    capture!("standard", "body/martin_000_10e/martin_000_10e_48000.wav"),
    capture!("blend", "body/martin_000_10e/martin_000_10e_48000_bld.wav"),
    capture!("match", "body/martin_000_10e/martin_000_10e_48000_match.wav"),
    capture!("jf", "body/martin_000_10e/martin_000_10e_48000_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static Martin00010eCapture> {
