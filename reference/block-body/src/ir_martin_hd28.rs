...
pub const MODEL_ID: &str = "martin_hd28";
pub const DISPLAY_NAME: &str = "HD-28";
...
pub const CAPTURES: &[Capture] = &[
    capture!("hd28_neumann_u87", "body/martin_hd28/hd28_neumann_u87.wav"),
    capture!("hd28_neumann_u47", "body/martin_hd28/hd28_neumann_u47.wav"),
    capture!("hd28_soundelux_e47", "body/martin_hd28/hd28_soundelux_e47.wav"),
    capture!("hd28_akg_c414b_xls", "body/martin_hd28/hd28_akg_c414b_xls.wav"),
    capture!("hd28_schoeps_cmc64g", "body/martin_hd28/hd28_schoeps_cmc64g.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("hd28_neumann_u87"), &[
            ("hd28_neumann_u87", "Neumann U87"), ("hd28_neumann_u47", "Neumann U47"), ("hd28_soundelux_e47", "Soundelux E47"),
            ("hd28_akg_c414b_xls", "AKG C414B XLS"), ("hd28_schoeps_cmc64g", "Schoeps CMC64G"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("hd28_neumann_u87".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
