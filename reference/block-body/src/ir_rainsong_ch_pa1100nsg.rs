...
pub const MODEL_ID: &str = "rainsong_ch_pa1100nsg";
pub const DISPLAY_NAME: &str = "CH-PA1100NSG";
const BRAND: &str = "rainsong";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        RainsongChPa1100nsgCapture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct RainsongChPa1100nsgCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[RainsongChPa1100nsgCapture] = &[
    capture!("standard", "body/rainsong_ch_pa1100nsg/jf_rainsong_ch_pa1100nsg_hfn_44100.wav"),
    capture!("blend", "body/rainsong_ch_pa1100nsg/jf_rainsong_ch_pa1100nsg_hfn_44100_bld.wav"),
    capture!("match", "body/rainsong_ch_pa1100nsg/rainsong_parlor_44100_matcheq.wav"),
    capture!("jf", "body/rainsong_ch_pa1100nsg/jf_rainsong_ch_pa1100nsg_hfn_44100_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static RainsongChPa1100nsgCapture> {
