...
pub const MODEL_ID: &str = "gibson_hummingbird_standard";
pub const DISPLAY_NAME: &str = "Hummingbird Standard";
...
pub const CAPTURES: &[Capture] = &[
    capture!("gibson_hummingbird_1_48000", "body/gibson_hummingbird_standard/gibson_hummingbird_1_48000.wav"),
    capture!("gibson_hummingbird_1_48000_bld", "body/gibson_hummingbird_standard/gibson_hummingbird_1_48000_bld.wav"),
    capture!("gibson_hummingbird_1_48000_match", "body/gibson_hummingbird_standard/gibson_hummingbird_1_48000_match.wav"),
    capture!("gibson_hummingbird_1_48000_jf_flavor", "body/gibson_hummingbird_standard/gibson_hummingbird_1_48000_jf_flavor.wav"),
    capture!("gibson_hummingbird_2_48000", "body/gibson_hummingbird_standard/gibson_hummingbird_2_48000.wav"),
    capture!("gibson_hummingbird_2_48000_bld", "body/gibson_hummingbird_standard/gibson_hummingbird_2_48000_bld.wav"),
    capture!("gibson_hummingbird_2_48000_match", "body/gibson_hummingbird_standard/gibson_hummingbird_2_48000_match.wav"),
    capture!("gibson_hummingbird_2_48000_jf_flavor", "body/gibson_hummingbird_standard/gibson_hummingbird_2_48000_jf_flavor.wav"),
];
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![enum_parameter("voicing", "Voicing", Some("Body"), Some("gibson_hummingbird_1_48000"), &[
            ("gibson_hummingbird_1_48000", "Position 1"), ("gibson_hummingbird_1_48000_bld", "Position 1 Blend"), ("gibson_hummingbird_1_48000_match", "Position 1 Match"), ("gibson_hummingbird_1_48000_jf_flavor", "Position 1 JF Flavor"),
            ("gibson_hummingbird_2_48000", "Position 2"), ("gibson_hummingbird_2_48000_bld", "Position 2 Blend"), ("gibson_hummingbird_2_48000_match", "Position 2 Match"), ("gibson_hummingbird_2_48000_jf_flavor", "Position 2 JF Flavor"),
        ])],
    }
}
...
#[cfg(test)] mod tests { use super::*; use block_core::param::ParameterSet; use block_core::{AudioChannelLayout, BlockProcessor}; use domain::value_objects::ParameterValue;
    ...
    #[test] #[ignore] fn builds_mono() { let mut p = ParameterSet::default(); p.insert("voicing", ParameterValue::String("gibson_hummingbird_1_48000".into())); match build_processor_for_model(&p, 48_000.0, AudioChannelLayout::Mono).unwrap() { BlockProcessor::Mono(_) => {} BlockProcessor::Stereo(_) => panic!("expected mono") } }
}
