...
pub struct EmeraldX20HfnCapture { pub voicing: &'static str, pub ir_file: &'static str }

pub const CAPTURES: &[EmeraldX20HfnCapture] = &[
    capture!("jf45ir1024x20", "body/emerald_x20_hfn/jf45ir1024x20.wav"),
    capture!("jf45ir5050x20", "body/emerald_x20_hfn/jf45ir5050x20.wav"),
    capture!("jf45irx20", "body/emerald_x20_hfn/jf45irx20.wav"),
];
