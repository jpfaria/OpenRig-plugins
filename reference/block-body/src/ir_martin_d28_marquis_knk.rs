...
pub const MODEL_ID: &str = "martin_d28_marquis_knk";
pub const DISPLAY_NAME: &str = "D-28 Marquis K&K";
const BRAND: &str = "martin";

macro_rules! capture {
    ($p1:literal, $ir_file:literal) => {
        MartinD28MarquisKnkCapture {
            flavor: $p1,
            ir_file: $ir_file,
        }
    };
...
pub struct MartinD28MarquisKnkCapture {
    pub flavor: &'static str,
    pub ir_file: &'static str,
}

pub const CAPTURES: &[MartinD28MarquisKnkCapture] = &[
    capture!("standard", "body/martin_d28_marquis_knk/martin_d28_marquis_knk_44100.wav"),
    capture!("blend", "body/martin_d28_marquis_knk/martin_d28_marquis_knk_44100_bld.wav"),
    capture!("match", "body/martin_d28_marquis_knk/martin_d28_marquis_knk_44100_match.wav"),
    capture!("jf", "body/martin_d28_marquis_knk/martin_d28_marquis_knk_44100_jf_flavor.wav"),
];
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MartinD28MarquisKnkCapture> {
