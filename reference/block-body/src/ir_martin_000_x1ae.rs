...
pub const CAPTURES: &[Martin000X1aeCapture] = &[
    capture!("standard", "body/martin_000_x1ae/martin_000x1ae_zoomh4np_48000.wav"),
    capture!("blend", "body/martin_000_x1ae/martin_000x1ae_zoomh4np_48000_bld.wav"),
    capture!("match", "body/martin_000_x1ae/martin_000x1ae_zoomh4np_48000_match.wav"),
    capture!("jf", "body/martin_000_x1ae/martin_000x1ae_zoomh4np_48000_jf_flavor.wav"),
];
