...
pub const MODEL_ID: &str = "nam_laney_ironheart_irt120";
pub const DISPLAY_NAME: &str = "Ironheart IRT120";
...
pub fn model_schema() -> ModelParameterSchema {
    ...
    schema.parameters = vec![enum_parameter(
        ...
        "Preset",
        Some("Amp"),
        Some("irt120_crunchy_red"),
        &[
            ("irt120_crunchy_red", "IRT120_crunchy_RED"),
            ("irt120_lead_red", "IRT120_lead_RED"),
            ("irt120_growl_red", "IRT120_growl_RED"),
            ("irt120_doom", "IRT120_doom"),
        ],
    )];
    schema
}
