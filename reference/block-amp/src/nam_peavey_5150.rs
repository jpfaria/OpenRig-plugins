...
pub const MODEL_ID: &str = "nam_peavey_5150";
...
pub const CAPTURES: &[Peavey5150Capture] = &[
    capture(
        "clean",
        "4x12_v30",
        "amps/peavey_5150/peavey_clean_4x12_v30.nam",
    ),
    capture(
        "clean",
        "4x12_greenback",
        "amps/peavey_5150/peavey_clean_4x12_greenback.nam",
    ),
    capture(
        "clean",
        "4x12_g12t",
        "amps/peavey_5150/peavey_clean_4x12_g12t.nam",
    ),
    capture(
        "crunch",
        "4x12_v30",
        "amps/peavey_5150/peavey_crunch_4x12_v30.nam",
    ),
    capture(
        "crunch",
        "4x12_greenback",
        "amps/peavey_5150/peavey_crunch_4x12_greenback.nam",
    ),
    capture(
        "crunch",
        "4x12_g12t",
        "amps/peavey_5150/peavey_crunch_4x12_g12t.nam",
    ),
    capture(
        "drive",
        "4x12_v30",
        "amps/peavey_5150/peavey_drive_4x12_v30.nam",
    ),
    capture(
        "drive",
        "4x12_greenback",
        "amps/peavey_5150/peavey_drive_4x12_greenback.nam",
    ),
    capture(
        "drive",
        "4x12_g12t",
        "amps/peavey_5150/peavey_drive_4x12_g12t.nam",
    ),
];
...
const fn capture(
    ...
    Peavey5150Capture {
        params: Peavey5150Params { gain, cabinet },
        model_path,
    }
}
