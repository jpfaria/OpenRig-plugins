...
pub const MODEL_ID: &str = "lv2_gx_blueamp";
pub const DISPLAY_NAME: &str = "GxBlueAmp";
const BRAND: &str = "guitarix";

const PLUGIN_URI: &str = "http://guitarix.sourceforge.net/plugins/gx_blueamp_#_blueamp_";
const PLUGIN_DIR: &str = "gx_blueamp";

#[cfg(target_os = "macos")]
const PLUGIN_BINARY: &str = "gx_blueamp.dylib";
#[cfg(target_os = "linux")]
const PLUGIN_BINARY: &str = "gx_blueamp.so";
#[cfg(target_os = "windows")]
const PLUGIN_BINARY: &str = "gx_blueamp.dll";

// LV2 port indices (from TTL)
const PORT_AUDIO_OUT: usize = 0;
const PORT_AUDIO_IN: usize = 1;
const PORT_BYPASS: usize = 2;
const PORT_MASTER: usize = 3;
...
pub fn model_schema() -> ModelParameterSchema {
    ModelParameterSchema {
        ...
        parameters: vec![
            float_parameter("master", "Master", None, Some(50.0), 0.0, 100.0, 1.0, ParameterUnit::Percent),
            float_parameter("tone", "Tone", None, Some(50.0), 0.0, 100.0, 1.0, ParameterUnit::Percent),
            float_parameter("volume", "Volume", None, Some(50.0), 0.0, 100.0, 1.0, ParameterUnit::Percent),
        ],
    }
}
...
fn build(params: &ParameterSet, sample_rate: f32, layout: AudioChannelLayout) -> Result<BlockProcessor> {
    let master = required_f32(params, "master").map_err(anyhow::Error::msg)? / 100.0;
    ...
    let processor = lv2::build_lv2_processor(
        ...
        &[(PORT_BYPASS, 1.0), (PORT_MASTER, master), (PORT_TONE, tone), (PORT_VOLUME, volume)],
    )?;
