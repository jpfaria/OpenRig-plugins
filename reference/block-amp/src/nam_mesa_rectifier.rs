...
pub const MODEL_ID: &str = "nam_mesa_rectifier";
pub const DISPLAY_NAME: &str = "Rectifier";
const BRAND: &str = "mesa";

pub const NAM_PLUGIN_FIXED_PARAMS: NamPluginParams = DEFAULT_PLUGIN_PARAMS;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct MesaRectifierParams {
    pub gain: &'static str,
    pub cabinet: &'static str,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct MesaRectifierCapture {
    pub params: MesaRectifierParams,
    pub model_path: &'static str,
}

pub const CAPTURES: &[MesaRectifierCapture] = &[
    capture(
        "crunch_orange",
        "4x12_v30",
...
pub fn model_schema() -> ModelParameterSchema {
    ...
    schema.parameters = vec![
        enum_parameter(
            ...
            Some("Amp"),
            Some("crunch_orange"),
            &[("crunch_orange", "Crunch Orange"), ("drive_red", "Drive Red")],
        ),
        enum_parameter(
            "cabinet",
            "Cabinet",
...
fn resolve_capture(params: &ParameterSet) -> Result<&'static MesaRectifierCapture> {
...
) -> MesaRectifierCapture {
    MesaRectifierCapture {
        params: MesaRectifierParams { gain, cabinet },
        model_path,
    }
}
