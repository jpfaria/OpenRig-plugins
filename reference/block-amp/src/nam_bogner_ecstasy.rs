...
pub const CAPTURES: &[BognerEcstasyCapture] = &[
    capture(
        "clean",
        "4x12_v30",
        "amps/bogner_ecstasy/ecstacy_clean_4x12_v30.nam",
    ),
    capture(
        "clean",
        "4x12_greenback",
        "amps/bogner_ecstasy/ecstacy_clean_4x12_greenback.nam",
    ),
    capture(
        "clean",
        "4x12_g12t",
        "amps/bogner_ecstasy/ecstacy_clean_4x12_g12t.nam",
    ),
    capture(
        "crunch",
        "4x12_v30",
        "amps/bogner_ecstasy/ecstacy_crunch_blue_4x12_v30.nam",
    ),
    capture(
        "crunch",
        "4x12_greenback",
        "amps/bogner_ecstasy/ecstacy_crunch_blue_4x12_greenback.nam",
    ),
    capture(
        "crunch",
        "4x12_g12t",
        "amps/bogner_ecstasy/ecstacy_crunch_blue_4x12_g12t.nam",
    ),
    capture(
        "drive",
        "4x12_v30",
        "amps/bogner_ecstasy/ecstacy_drive_red_4x12_v30.nam",
    ),
    capture(
        "drive",
        "4x12_greenback",
        "amps/bogner_ecstasy/ecstacy_drive_red_4x12_greenback.nam",
    ),
    capture(
        "drive",
        "4x12_g12t",
        "amps/bogner_ecstasy/ecstacy_drive_red_4x12_g12t.nam",
    ),
];
