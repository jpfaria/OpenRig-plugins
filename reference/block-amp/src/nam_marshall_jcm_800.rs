...
pub const MODEL_ID: &str = "nam_marshall_jcm_800";
pub const DISPLAY_NAME: &str = "JCM 800";
...
pub const CAPTURES: &[MarshallJcm800Capture] = &[
    capture(
        "clean",
        "4x12_v30",
        "amps/marshall_jcm_800/jcm_800_clean_4x12_v30.nam",
    ),
    capture(
        "clean",
        "4x12_greenback",
        "amps/marshall_jcm_800/jcm_800_clean_4x12_greenback.nam",
    ),
    capture(
        "clean",
        "4x12_g12t",
        "amps/marshall_jcm_800/jcm_800_clean_4x12_g12t.nam",
    ),
    capture(
        "crunch",
        "4x12_v30",
        "amps/marshall_jcm_800/jcm_800_crunch_4x12_v30.nam",
    ),
    capture(
        "crunch",
        "4x12_greenback",
        "amps/marshall_jcm_800/jcm_800_crunch_4x12_greenback.nam",
    ),
    capture(
        "crunch",
        "4x12_g12t",
        "amps/marshall_jcm_800/jcm_800_crunch_4x12_g12t.nam",
    ),
    capture(
        "drive",
        "4x12_v30",
        "amps/marshall_jcm_800/jcm_800_drive_4x12_v30.nam",
    ),
    capture(
        "drive",
        "4x12_greenback",
        "amps/marshall_jcm_800/jcm_800_drive_4x12_greenback.nam",
    ),
    capture(
        "drive",
        "4x12_g12t",
        "amps/marshall_jcm_800/jcm_800_drive_4x12_g12t.nam",
    ),
];
...
const fn capture(
    ...
    MarshallJcm800Capture {
        params: MarshallJcm800Params { gain, cabinet },
        model_path,
    }
}
