...
fn build_mono_processor(
    sample_rate: f32, delay: f32, mix: f32, feedback: f32, warp: f32, filter: f32, rate: f32,
    ...
    lv2::build_lv2_processor(
        ...
        &[
            (PORT_DELAY, delay), (PORT_MIX, mix), (PORT_FEEDBACK, feedback),
            (PORT_WARP, warp), (PORT_FILTER, filter), (PORT_RATE, rate),
        ],
    )
}
